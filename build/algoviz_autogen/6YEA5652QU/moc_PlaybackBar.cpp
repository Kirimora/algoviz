...
void PlaybackBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 5: _t->seek((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        case 6: _t->tick(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (PlaybackBar::*)(int )>(_a, &PlaybackBar::frameChanged, 0))
            return;
    }
}
...
// SIGNAL 0
void PlaybackBar::frameChanged(int _t1)
{
